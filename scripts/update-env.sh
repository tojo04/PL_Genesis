...
DAO_REGISTRY_ID=$(dfx canister id cerebrum_registry)
DAO_ANALYTICS_ID=$(dfx canister id cerebrum_analytics)
...
VITE_CANISTER_ID_CEREBRUM_FRONTEND=${DAO_FRONTEND_ID}
...
echo ""
echo "🔄 Rebuild frontend with: cd src/cerebrum_frontend && npm run build"
