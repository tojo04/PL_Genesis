...
const LandingPage = () => {
  ...
  const features = [
    {
      ...
      description: 'Neural and biometric data is encrypted client-side before upload',
      color: 'from-cyan-400 to-blue-500'
    },
    {
      icon: Zap,
      title: 'Programmable Consent',
      description: 'Grant access by wallet identity, purpose, and duration',
      color: 'from-yellow-400 to-orange-500'
    },
    {
      icon: Users,
      title: 'Research Collaboration',
      description: 'Share protected telemetry with apps and researchers safely',
      color: 'from-green-400 to-emerald-500'
    },
    {
      icon: TrendingUp,
      title: 'Revocable Access',
      description: 'Revoke consent anytime and enforce decryption denial instantly',
      color: 'from-purple-400 to-pink-500'
    }
  ];

  const stats = [
    { label: 'Encrypted Records', value: '38', icon: Coins },
    { label: 'Active Consents', value: '11', icon: Rocket },
    { label: 'Revocations Enforced', value: '6', icon: Users },
    { label: 'Policy Match Rate', value: '99.7%', icon: TrendingUp }
  ];

  const projects = [
    {
      name: 'Sleep Study Cohort',
      description: 'EEG sessions shared with time-boxed consent',
      raised: '142 CIDs',
      target: '220 CIDs',
      participants: 43,
      status: 'Live',
    ...
    {
      name: 'Cognitive Load Lab',
      description: 'Purpose-scoped access for neuro app benchmarking',
      raised: '91 CIDs',
      target: '180 CIDs',
      participants: 27,
      status: 'Live',
    ...
    {
      name: 'Clinical Sandbox',
      description: 'Upcoming trial with staged consent and revocation',
      raised: '0 CIDs',
      target: '150 CIDs',
      participants: 12,
      status: 'Upcoming',
  ...
  const heroSlides = [
    ...
    },
    {
      ...
      subtitle: "GRANULAR ACCESS, ZERO TRUST",
      description: "Authorize access by wallet, purpose, and duration with Lit policies"
    },
    {
      title: "REVOKE ANYTIME",
      subtitle: "COLLABORATE WITHOUT LOSING SOVEREIGNTY",
      description: "Store encrypted payloads on Storacha/Filecoin and revoke access instantly"
    }
  ];
          ...
          <div className="max-w-7xl mx-auto px-4">
            ...
            >
              ...
              <p className="text-xl text-gray-300 max-w-2xl mx-auto font-mono">
                {'>'} Build secure neural data sharing flows with revocable consent
              </p>
            </motion.div>
        ...
        <section className="py-20 relative">
          <div className="max-w-7xl mx-auto px-4">
            ...
            >
              ...
              <p className="text-xl text-gray-300 max-w-2xl mx-auto font-mono">
                {'>'} Monitor encrypted datasets and permissioned collaborations
              </p>
            </motion.div>
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <p className="text-xl text-gray-300 mb-8 font-mono">
                  {'>'} Connect Flow wallet, upload encrypted telemetry, and control every permission.
                </p>
                <Link
                  to="/upload"
